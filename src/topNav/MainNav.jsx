  ...
  return (
    ...
    >
        <div className='flex justify-between w-3/5 flex-row-reverse lg:justify-start lg:w-10/12 lg:flex-row items-center'>
            ...
            <Link to='/' className={`font-bold text-3xl text-primary -translate-x-3 lg:translate-x-0 `}>LUNA</Link>
        ...
        <div className='text-3xl flex justify-end gap-6 w-1/3'>
            ...
            <Link 
                to={'cart'} 
                aria-label='Cart' 
                className="transition-transform duration-500 transform hover:scale-105 relative"
            >
                <i>
                    <CiShoppingCart /> 
                    <span className='absolute text-[10px] -translate-y-4 translate-x-4 bg-primary rounded-4xl text-white px-1.5 py-0.5'>
                        {quantityInCart()}
                    </span>
                </i>
            </Link>
